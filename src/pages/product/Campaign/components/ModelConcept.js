...
import image1 from "images/Product/Campaign/image-1.png"
          ...
          <div className="VWySdLLKwa">
            <div className="SXoRqGRTZg">
              ...
              <div className="FCjitlxKsb">
                <div className="JDOVFGvteG">{`A. Next-Best-Offer -
Model Concept`}</div>
              </div>
            </div>
            <div className="WTKPvPwjkv">
              <div className="AdwbmnHxqQ">
                ...
                <div className="VynXYuiuKj">
                  Grow revenue by recommending the most relevant products for
              ...
              <div className="AdwbmnHxqQ">
                ...
                <div className="VynXYuiuKj">
                  AI analyzes entire customer database to find the highest
                  potential SKUs for every customer’s next purchase
                </div>
              </div>
              <div className="AdwbmnHxqQ">
